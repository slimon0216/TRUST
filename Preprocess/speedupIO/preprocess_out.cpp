...
bool cmp_fast1(sortarr a, sortarr b) { return a.value < b.value; }
bool cmp_fast2(sortarr a, sortarr b) { return a.value > b.value; }
...
void computeCSR() {
  ...
  for (int i = 0; i < vertex_count; i++) {
    ...
    adjFile.write((char *)&vertex[i].edge[0],
                  sizeof(int) * vertex[i].edge.size());
